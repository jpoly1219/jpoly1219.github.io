...
var $author$project$Main$viewMain = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('arrow arrow-down')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('↓')
...
var $author$project$Main$viewWork1 = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('arrow arrow-up')
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('↑')
...
var $author$project$Main$view = function (_v0) {
	return A2(
		...
		_List_fromArray(
			[$author$project$Main$viewMain, $author$project$Main$viewWork1, $author$project$Main$viewWork2]));
};
